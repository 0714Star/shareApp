...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "f120e410-10-" + i0 + "," + ("f120e410-9-" + i0),
        b: item.id,
        c: "f120e410-9-" + i0 + ",f120e410-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
